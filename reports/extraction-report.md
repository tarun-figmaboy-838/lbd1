# Extraction report — lbd1

Source scenes: `Assets/Scenes/Main.unity`, `Assets/Scenes/LBD1.unity`
...
| LBD1 | `CameraShake` | 1 |
| LBD1 | `GemCollectEffect` | 9 |
| LBD1 | `GemMover` | 1 |
| LBD1 | `TutorialClickableButton` | 9 |
| LBD1 | `TutorialDialogue` | 2 |
| LBD1 | `TypewriterEffect` | 1 |

## Assets

- referenced by layout/config: **86**
- files copied: **86** ({'img': 60, 'audio': 25, 'fonts': 1})
- atlas-cropped sprites: 0
- 9-sliced sprites carrying border data: 1
- missing: 0 | zero-byte: 0 | runtime path violations: 0
- runtime asset paths checked: 92, all relative and under `assets/`
- Unity project paths present as provenance labels only (Animator controller names, ScriptableObject sources): 4 — none is fetched at runtime
